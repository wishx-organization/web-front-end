import { Birthday, Blue_div, Blue_top_div, Blue_loading_div,Last_title, Left_buttons, Left_div, Left_image, Left_report, Main_page, Main_page_top, Middle_title, Photo, Right_div, Right_top_div, Top_title, Blue_button_div, Vashed, Congratulate, Congratulate_button, Product, Product_part, Product_other, All_congrulation, Hbd, Hbd_title, Hbd_name, Hbd_footer, Photos, Hbday, Mcdonalds, Picture, Mcago, Freecofe, Bottom_div, Bottom_div_title, Bottom_div_show } from "./Wish-pages.styled";
...
import { Blue_left_div, Blue_right_div, Paragraph,Photoone,Phototwo,Right_blue_bottom,Right_blue_div } from "./Add.styled";

function Wish_pages_second() {
    return(
        <Main_page>
            <Main_page_top>
             <Left_div>
             ...
             <Right_div>
                ...
                <Right_blue_div>
                    ...
                    <Photoone src="https://i2.wp.com/cigirbirlik.com/wp-content/uploads/2019/06/bank_respublika_logo_291018.jpg?resize=768%2C442&ssl=1"/>
                    <Phototwo src="https://i2.wp.com/cigirbirlik.com/wp-content/uploads/2019/06/bank_respublika_logo_291018.jpg?resize=768%2C442&ssl=1"/>
                    </Right_blue_bottom>
...
export default Wish_pages_second;