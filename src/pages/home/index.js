...
const Home = () => {
  useEffect(() => {
    ...
    // let arrow_left_icon = document.createElement('i');
    // arrow_left_icon.className = 'fa-solid fa-arrow-left-long';
    // arrow_left.appendChild(arrow_left_icon);
    
    // let arrow_right_icon = document.createElement('i');
    // arrow_right_icon.className = 'fa-solid fa-arrow-right-long';
    // arrow_right.appendChild(arrow_right_icon);
  ...
  return (
    <>
      <HomeConatiner fluid p={0} style={{overflow: 'hidden'}}>
        <HomeTop columns={24}>
