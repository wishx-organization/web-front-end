...
import MobileMessage from "./mobile";
...
class Messages extends Component{
    ...
    render() {
        ...
        return (
            <MessagesContainer fluid>
                <Grid className="root-grid-for-mobile">
                    <Grid.Col md={3} >
                        <LeftMessageSection>
                            <SearchContainer>
                    ...
                    <Grid.Col md={6} style={{ background: '#F7F8FA',boxShadow: '0px 5px 60px #0000000f'  }}>
                        <MessageSectionUser>
                    ...
                    <Grid.Col md={3}>
                        <RightSection>
                            ...
                            <Image radius="100px" className="tomcruse" height={85} src="https://s3-alpha-sig.figma.com/img/2d64/31a1/53d9d3b5efd0efe87648846f6bd08e5e?Expires=1665964800&Signature=gs6nSGc8WEiR3bVWNE9Co-YbcX-eahJYf0~nS4oa8wjOOdeWpX8O4b~bPNJyNLujuxHXcxWmDoiwDK9s-U0fIX1-MjPS71VLh8fMucl1O9XF-Csg7oEP0GWa9IOCyM0a6PRNzy3TOgoZneKpSZ-H10vPvruFypBK-dAb-txbzMvyrVWi-Ay0xF88UTd~6YheGhXJRGUvxzRXG6aurDB~vCakMd~73ZB2px27EbiEBAey2e4CwzIGn1s0zCz7IxZxlDqQYXvxdhpSK8I3tvFFFwuZiOO3quLg0q4lXMHrVuhe7VklwD5-jfZmje5IfAIUJ5I1wa2UMfBTvijI8B1lxg__&Key-Pair-Id=APKAINTVSUGEWH5XD5UA" />
                            <Namesurname>Jenny Wilson<HiBadgeCheck className='bluechek' /></Namesurname>
                            <TagName>@ jwilson</TagName>
                            <Text>When human beings experience <br/> trauma or severe life stressors, it is not <br/> uncommon for their lives to unravel</Text>
                            <DateSection>
                                <Date>5 November 1992</Date>
                                <DateText>Birthdate</DateText>
                            </DateSection>
                            <DisplayDateBirthaySection>
                                <Date>14 March 1987 <DateText>Birthdate</DateText></Date>
                                <Follower>144 <DateText>followers</DateText></Follower>
                                <Following>156 <DateText>followings</DateText></Following>
                            </DisplayDateBirthaySection>
                            <FollowersSection>
                                <Follower>1 566 <br /> <span style={{ fontSize: "12px" }}>followers</span></Follower>
                                <Following>2 312 <br /> <span style={{ fontSize: "12px" }}>followings</span></Following>
                            </FollowersSection>
                            <ButtonSection>
                        ...
                        <CardLong>
                            <UserLastWishText>User’s last wishes</UserLastWishText>
                            <div className='cont-text'>
                                <Imagess src="https://s3-alpha-sig.figma.com/img/e5a4/30c8/644aced30fd3d3966a32e26e447458b6?Expires=1665964800&Signature=DYDhu1iZZvmYqi2yF9xLXM9sMSAZMr~~alwVIykrCoWWWUjnnuykpm3nqrAymVuhwLzAX41Bom2N-Ds3Oke34~YRK0HXPcX8C-FKTuEm-~~t4hsbxNxq7GL5UZ8E-3rFSXmqcjjQiOE3B6Y5~aEByF8~NHJ~~gc4FLXAAoGoKDPYEiPZaz1Xdc7IgMf-ifozfOnvqAl-mpVgSyyqXc8hnwhb-dvg43iUHJH--pR6Af7QpRQVF~iW5l4WFoVfSqXvuxgTxtWDeHB5-zyO0MrHqCPqAF8QSJ4JoNx8AQ0lbdLvIgIxd71OAMh5X8MiaI8rj~cwP5J9lKoh-clfE0qcnA__&Key-Pair-Id=APKAINTVSUGEWH5XD5UA" />
                                <Title>Sneakers for boys Adidas<br/> GZ0648, blue, mesh, size 35</Title>
                                {/* <UserDesc>{index.userdesc}</UserDesc> */}
                                <Progress size="sm" className="slider" sections={[{ value: 40, color: "#3800B0" }]} />
                                <Price><Firstprice>$2,542 raised</Firstprice><Lastprice>$8,558 left</Lastprice></Price>
                            </div>
                        </CardLong>
                    </Grid.Col>
                </Grid>
